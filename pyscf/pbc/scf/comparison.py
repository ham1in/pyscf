...
def khf_exchange_ss(kmf, nks, N_local=5, dm_kpts=None):
    #   basic info
    cell = kmf.cell
    kpts = kmf.kpts
    nks = np.array(nks)
    ...
    e_ex_ss = e_ex_madelung + prefactor_ex * ss_correction
    return e_ex, e_ex_madelung, e_ex_ss

###Debugging for Diamond
cell = pbc.gto.Cell()
...
kmf = pbc.scf.KRHF(cell, kpts)
kmf.exxdiv = None
ehf = kmf.kernel()
dm_kpts = kmf.make_rdm1()
e_ex, e_ex_madelung, e_ex_ss2 = khf_exchange_ss(kmf,[2,2,2], dm_kpts = dm_kpts)
print(e_ex_ss2)