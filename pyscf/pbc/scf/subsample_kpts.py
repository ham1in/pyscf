...
def subsample_kpts(mf, dim, div_vector, dm_kpts = None, stagger_type = None, df_type = None,  exxdiv ='ewald',wrap_around=False, singularity_subtraction=False, ss_nlocal=7, ss_localizer=None):
    """
